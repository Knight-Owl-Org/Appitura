  ...
  return (
    <div className="bg-black p-4 md:p-8 w-full">
      <div className="flex flex-wrap gap-x-4 justify-center max-w-[1280px] mx-auto">
        {/* Tile 1 */}
        <div className="rounded-lg overflow-hidden relative mb-4 w-[260px] md:w-[300px] lg:w-[280px] xl:w-[320px] h-[260px] md:h-[300px] lg:h-[280px] xl:h-[320px]">
        ...
        {/* Tile 2 */}
        <div className="rounded-lg overflow-hidden relative mb-4 w-[320px] md:w-[360px] lg:w-[340px] xl:w-[400px] h-[260px] md:h-[300px] lg:h-[280px] xl:h-[320px]">
