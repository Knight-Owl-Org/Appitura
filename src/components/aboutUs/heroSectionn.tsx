    ...
    <main className=" w-full bg-black flex  overflow-hidden relative">
      ...
      >
        ...
        <motion.div
          ...
          className="hidden sm:block absolute top-[10px] left-[-100px] z-10 w-[150px] h-[100px] sm:w-[240px] sm:h-[180px] lg:w-[340px] lg:h-[250px] pointer-events-none"
        >
        ...
        <motion.div
          ...
          className="hidden sm:block absolute bottom-[20px] right-[-100px] z-10 w-[150px] h-[90px] sm:w-[270px] sm:h-[180px] lg:w-[374px] md:h-[221px] pointer-events-none"
        >
