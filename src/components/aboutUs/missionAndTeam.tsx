export default function Page() {
  return (
    <main className="w-full bg-black text-white pb-10 px-4 md:px-[93px] flex flex-col items-center justify-center">
      <div className="w-full  max-w-none">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="relative rounded-3xl mb-6 md:mb-0">
            ...
            {/* Content */}
            <div className="relative z-10 bg-black rounded-3xl pb-[109px] pt-[39px] flex flex-col h-full">
          ...
          <div className="relative rounded-3xl">
            ...
            <div className="relative z-10 bg-black rounded-3xl pb-[109px] pt-[39px] flex flex-col h-full">
              ...
              <p className="text-white text-sm md:text-base max-w-[436px] mx-auto" style={{ fontFamily: "Inter" }}>
